...
export default function Contact() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setLoading(false);
    if (res.ok) {
      setSuccess("Thanks! Your request was received. We'll contact you shortly.");
      ...
      <section className="container mx-auto grid grid-cols-1 gap-8 px-4 py-12 md:grid-cols-2">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Fill out the form and our team will reach out to confirm details and pricing.
          </p>
        ...
        <form onSubmit={onSubmit} className="rounded-xl border bg-card p-6 shadow-sm">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <Textarea name="notes" placeholder="Tell us more about your vehicle or any concerns" />
            </div>
          </div>
