          ...
          <div className="sticky top-20 space-y-4">
            ...
            <div className="rounded-lg border p-4">
              ...
              <div className="mt-3 grid gap-2">
                ...
                <Link
                  to="/staff/clients?create=true"
                  className="rounded-md border px-3 py-2 text-sm"
                >
                  Add Client Manually
                </Link>
                <Link
                  to="/staff/invoices?create=true"
                  className="rounded-md border px-3 py-2 text-sm"
                >
                  Create Invoice
                </Link>
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div className="rounded-lg border p-4">
              <div className="flex items-center justify-between">
                ...
                <Link to="/staff/jobs" className="text-sm text-primary">
                  View all
                </Link>
              </div>
                ...
                {jobs.slice(0, 4).map((j) => (
                  <div key={j.id} className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        {j.status} • {j.scheduledAt ?? "—"}
                      </div>
                    </div>
                    <div className="text-sm text-muted-foreground">
                      {j.clientId ? "Client" : "Guest"}
                    </div>
                  </div>
                ))}
                {jobs.length === 0 && (
            ...
            <div className="rounded-lg border p-4">
              <div className="flex items-center justify-between">
                ...
                <Link to="/staff/clients" className="text-sm text-primary">
                  View all
                </Link>
              </div>
              <div className="mt-3 space-y-3">
            ...
            <div className="rounded-lg border p-4">
              <div className="flex items-center justify-between">
                ...
                <Link to="/staff/invoices" className="text-sm text-primary">
                  View all
                </Link>
              </div>
              <div className="mt-3 space-y-3">
